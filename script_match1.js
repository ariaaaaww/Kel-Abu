// =====================================================================
// BAGIAN 1: DATA & SETUP (Sesuaikan untuk setiap file script_matchX.js)
// =====================================================================

const allGameData = [
  // Data Match 1 (Tim A vs B)
  {
    match: 1,
    round: 1,
    question: "Gerakan refleks apa yang biasa dilakukan saat tertawa?",
    answers: [
      { text: "Memukul objek/orang", score: 39, revealed: false },
      { text: "Menutup Mulut", score: 32, revealed: false },
      { text: "Memegang Perut", score: 7, revealed: false },
      { text: "Ketawa", score: 5, revealed: false },
      { text: "Tepuk Tangan", score: 4, revealed: false },
      { text: "Membuka Mulut", score: 2, revealed: false },
    ],
  },
  {
    match: 1,
    round: 2,
    question:
      "Apa yang tidak mau dilihat oleh pencuri ketika mau maling ke rumah orang?",
    answers: [
      { text: "Pemilik Rumah / Orang", score: 43, revealed: false },
      { text: "CCTV", score: 19, revealed: false },
...
const teams = {
  // Sesuaikan Nama Tim (Contoh: Tim A vs Tim B)
  team1: {
...
const totalGamePoints = {
  team1: 0,
  team2: 0,
  matchId: allGameData[0].match, // ID Match saat ini (1, 2, atau 3)
};
...
/**
 * 💥 BARU: Memuat total skor Match sebelumnya dari localStorage.
 */
...
function endMatch() {
  ...
  // 2. Simpan skor Match ini (Match 1 atau Match 2) ke localStorage untuk Match berikutnya
 ...
 */
function endGame() {
  // Skor final sudah ada di totalGamePoints dari Match terakhir (Match 3)
